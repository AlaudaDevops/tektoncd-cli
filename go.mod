...
replace (
	...
	github.com/google/gnostic-models => github.com/google/gnostic-models v0.6.9-0.20230804172637-c7be7c783f49
...
// Because the community needs to upgrade to v2 version to solve security issues, so replace it with the version maintained by alauda
replace github.com/sigstore/timestamp-authority => github.com/alaudadevops/timestamp-authority v1.2.10-alauda.3

replace github.com/tektoncd/chains => github.com/AlaudaDevops/chains v0.19.2-0.20260304040940-ee32327fe2af

replace github.com/tektoncd/pipeline => github.com/AlaudaDevops/pipeline v0.56.10-alauda.1

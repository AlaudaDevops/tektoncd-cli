...
// Because version 1.10.0 has compatibility issues, revert to version 1.9.5
replace github.com/sigstore/sigstore => github.com/sigstore/sigstore v1.9.5

// Becase the community needs to upgrade to v2 version to solve security issues, so replace it with the version maintained by alauda
